...
class UserSignupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "email", "password", "access", "re_password", "refresh")
    ...
    def validate(self, validated_data):
        ...
        raise exceptions.ValidationError({"re_password": _("Password not match")}, 'wrong_password')
...
class UserAccountResendConfirmationSerializer(serializers.Serializer):
...
class UserAccountChangePasswordSerializer(serializers.Serializer):
    ...
    re_new_password = serializers.CharField(write_only=True, help_text=_("New password"))
