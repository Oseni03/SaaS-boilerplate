...
class PaymentIntentSerializer(serializers.ModelSerializer):
    ...
    price_id = serializers.JSONField()

    class Meta:
        model = djstripe_models.PaymentIntent
        fields = ('id', 'amount', 'currency', 'client_secret', 'price_id')
    ...
    def create(self, validated_data):
        ...
        price = models.Price.objects.get(id=int(validated_data['price_id']))
...
class PriceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'unit_amount', 'recurring', 'currency')
...
class SubscriptionItemProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'prices', 'default_price')
